    ...
    return (
        <tr key={props.id}>
            ...
            <td className={styles.days}>{!editModeDays ?
                ...
                <div><input type='number' min='0' value={props.daysWorked} className={styles.days_input} onChange={onChangeDays}/> 
            ...
            <td className={styles.rate}>{!editModeRate ?
                ...
                <div><input type='number' min='0' value={props.rate} className={styles.rate_input} onChange={onChangeRate}/> 
